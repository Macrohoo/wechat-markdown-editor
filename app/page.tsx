...
const THEMES: Record<ThemeName, { label: string; color: string; css: string }> = {
  ...
  lime: {
    ...
    css: `
      ...
      #wechat-content .lime-body blockquote:before { content:"★ 总结"; position:absolute; top:-1px; left:-1px; padding:5px 12px; background:#C2F54A; color:#111111; font-size:15px; line-height:1.4; font-style:normal; font-weight:750; }
